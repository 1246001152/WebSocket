...
<h3>欢迎 <b id="user"><%=session.getAttribute("username")%></b>使用本聊天系统！！</h3>

<div id="content"
     style="border: 1px solid black; width: 400px; height: 300px; float: left; color: #7f3f00;overflow-y:scroll; overflow-x:scroll;"></div>
<div id="userList"
